...
const Checkout = () => {
  ...
  const handleCheckout = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://toursandtravels-udew.onrender.com/bookings",
        {
          method: "POST",
          headers: {
  ...
  const data = [
    {
      Kathmandu:
        "https://images.unsplash.com/photo-1617469165786-8007eda3caa7?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&dl=raimond-klavins-JqT2Wp5S0Dk-unsplash.jpg",
      Pokhara:
        "https://images.unsplash.com/photo-1540961018629-a53dfce2fb66?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&dl=samrat-khadka-2bxAoXcfwwM-unsplash.jpg",
      Illam:
        "https://images.unsplash.com/photo-1700378232912-83bbfaedb9a3?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&dl=shanesh-np-wd5ivTbI8ME-unsplash.jpg",
      ...
      Solukhumbu:
        "https://images.unsplash.com/photo-1704538349509-d8b14546cbc1?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&dl=bibek-kc-UbOaPXlI8hA-unsplash.jpg",
    },
  ];
  ...
  const description = [
    {
      ...
      Illam:
        "Ilam is one of four urban municipalities of Ilam District, which lies in the Mahabharata hilly range of Koshi Province, eastern Nepal. Ilam also acts as the headquarters of Ilam District.",
      ...
      Solukhumbu:
        "Solukhumbu District is one of 14 districts of Koshi Province of eastern Nepal. As the name suggests, it consists of the subregions Solu and Khumbu.",
    },
  ];
